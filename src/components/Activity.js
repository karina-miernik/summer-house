...
export default function Activity  ({title, text, img}) {
  const [hover, setHover] = useState('');
  
  return (
    <div class="w-[60%] min-h-[90vh] mx-auto my-52 flex flex-col">
    <SectionTitle text="Poznaj okolicę" />
    <div class="flex flex-col md:flex-row flex-wrap w-full justify-center gap-1 items-center">
      <div
        id="button1"
